...
${require('marked')(t)}<hr>This project is open-sourced on <a href="https://github.com/unix/cobot">GitHub</a>.</div></body>`

execSync('(yarn add marked & mkdir dist) && cp -R .github ./dist && cp favicon.ico ./dist')
